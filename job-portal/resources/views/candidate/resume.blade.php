    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                <a href="{{ route('add_candidate_resume') }}" class="btn btn-primary btn-sm mb-2"><i class="fas fa-plus"></i> Add Resume</a>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('delete_candidate_resume',$item->id) }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure?');"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
